...
interface SettingsDocumentData {
  ...
  /**
   * Meta Descripcion field in *Settings*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: settings.meta_descripcion
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
   ...
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: settings.footer_iamge
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  footer_iamge: prismic.ImageField<never>;
...
export interface HeroSliceDefaultPrimary {
   ...
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.default.primary.head
  ...
  /**
   * Skate Board Bolt Color field in *Hero → Default → Primary*
   *
   * - **Field Type**: Color
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.default.primary.skate_board_bolt_color
   * - **Documentation**: https://prismic.io/docs/field#color
   */
  skate_board_bolt_color: prismic.ColorField;
}
...
export interface VideoBlockSliceDefaultPrimary {
   ...
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  youtubevideo_id: prismic.RichTextField;
}
